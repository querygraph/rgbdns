---
type: "code-fragment"
fragment_id: "rgbdns-frag-876ceeeecb26"
source_path: "docs/book/build-local.sh"
code_note: "DNS from First Principles/Code/docs/book/build-local.sh.source"
language: "bash"
subsystem: "Documentation"
symbol: "build-local.sh"
kind: "file"
start_line: 1
end_line: 48
---
...
- Fragment ID: `rgbdns-frag-876ceeeecb26`
- Source file: [[DNS from First Principles/Code/docs/book/build-local.sh.source|docs/book/build-local.sh]]
- Lines: 1-48
- Subsystem: [[DNS from First Principles/Subsystems/Documentation|Documentation]]

```rgbdns-fragment
{"id": "rgbdns-frag-876ceeeecb26", "codeNote": "DNS from First Principles/Code/docs/book/build-local.sh.source", "heading": "rgbdns-frag-876ceeeecb26: file build-local.sh", "sourcePath": "docs/book/build-local.sh", "startLine": 1, "endLine": 48}
```

## Excerpt

<span id="rgbdns-frag-876ceeeecb26" class="rgbdns-fragment-target"></span>
### rgbdns-frag-876ceeeecb26: file build-local.sh
