---
type: "code-fragment"
fragment_id: "rgbdns-frag-745e0bd50d8f"
...
- Fragment ID: `rgbdns-frag-745e0bd50d8f`
...
```rgbdns-fragment
{"id": "rgbdns-frag-745e0bd50d8f", "codeNote": "DNS from First Principles/Code/scripts/build-obsidian-vault.py.source", "heading": "rgbdns-frag-745e0bd50d8f: def build_vault", "sourcePath": "scripts/build-obsidian-vault.py", "startLine": 534, "endLine": 614}
```

## Excerpt

<span id="rgbdns-frag-745e0bd50d8f" class="rgbdns-fragment-target"></span>
### rgbdns-frag-745e0bd50d8f: def build_vault
