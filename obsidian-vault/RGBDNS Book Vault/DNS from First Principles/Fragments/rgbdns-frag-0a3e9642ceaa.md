---
type: "code-fragment"
fragment_id: "rgbdns-frag-0a3e9642ceaa"
...
- Fragment ID: `rgbdns-frag-0a3e9642ceaa`
...
```rgbdns-fragment
{"id": "rgbdns-frag-0a3e9642ceaa", "codeNote": "DNS from First Principles/Code/scripts/build-obsidian-vault.py.source", "heading": "rgbdns-frag-0a3e9642ceaa: def render_vault_readme", "sourcePath": "scripts/build-obsidian-vault.py", "startLine": 489, "endLine": 533}
```

## Excerpt

<span id="rgbdns-frag-0a3e9642ceaa" class="rgbdns-fragment-target"></span>
### rgbdns-frag-0a3e9642ceaa: def render_vault_readme
