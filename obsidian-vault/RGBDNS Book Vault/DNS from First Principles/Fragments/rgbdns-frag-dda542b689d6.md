---
type: "code-fragment"
fragment_id: "rgbdns-frag-dda542b689d6"
...
- Fragment ID: `rgbdns-frag-dda542b689d6`
- Source file: [[DNS from First Principles/Code/docs/book/rgbdns.md.source|docs/book/rgbdns.md]]
- Lines: 1142-1163
- Subsystem: [[DNS from First Principles/Subsystems/Documentation|Documentation]]

```rgbdns-fragment
{"id": "rgbdns-frag-dda542b689d6", "codeNote": "DNS from First Principles/Code/docs/book/rgbdns.md.source", "heading": "rgbdns-frag-dda542b689d6: heading A path through the code", "sourcePath": "docs/book/rgbdns.md", "startLine": 1142, "endLine": 1163}
```

## Excerpt

<span id="rgbdns-frag-dda542b689d6" class="rgbdns-fragment-target"></span>
### rgbdns-frag-dda542b689d6: heading A path through the code
