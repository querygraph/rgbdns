---
type: "code-fragment"
fragment_id: "rgbdns-frag-1a10503616a0"
...
- Fragment ID: `rgbdns-frag-1a10503616a0`
- Source file: [[DNS from First Principles/Code/docs/book/rgbdns.md.source|docs/book/rgbdns.md]]
- Lines: 334-349
- Subsystem: [[DNS from First Principles/Subsystems/Documentation|Documentation]]

```rgbdns-fragment
{"id": "rgbdns-frag-1a10503616a0", "codeNote": "DNS from First Principles/Code/docs/book/rgbdns.md.source", "heading": "rgbdns-frag-1a10503616a0: heading Truncation must preserve a valid message", "sourcePath": "docs/book/rgbdns.md", "startLine": 334, "endLine": 349}
```

## Excerpt

<span id="rgbdns-frag-1a10503616a0" class="rgbdns-fragment-target"></span>
### rgbdns-frag-1a10503616a0: heading Truncation must preserve a valid message
