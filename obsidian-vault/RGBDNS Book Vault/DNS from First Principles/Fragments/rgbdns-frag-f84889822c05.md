---
type: "code-fragment"
fragment_id: "rgbdns-frag-f84889822c05"
...
- Fragment ID: `rgbdns-frag-f84889822c05`
- Source file: [[DNS from First Principles/Code/docs/book/rgbdns.md.source|docs/book/rgbdns.md]]
- Lines: 596-622
- Subsystem: [[DNS from First Principles/Subsystems/Documentation|Documentation]]

```rgbdns-fragment
{"id": "rgbdns-frag-f84889822c05", "codeNote": "DNS from First Principles/Code/docs/book/rgbdns.md.source", "heading": "rgbdns-frag-f84889822c05: heading The cache is part of correctness", "sourcePath": "docs/book/rgbdns.md", "startLine": 596, "endLine": 622}
```

## Excerpt

<span id="rgbdns-frag-f84889822c05" class="rgbdns-fragment-target"></span>
### rgbdns-frag-f84889822c05: heading The cache is part of correctness
