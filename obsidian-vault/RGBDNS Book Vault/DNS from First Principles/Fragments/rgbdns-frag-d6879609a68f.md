---
type: "code-fragment"
fragment_id: "rgbdns-frag-d6879609a68f"
...
- Fragment ID: `rgbdns-frag-d6879609a68f`
- Source file: [[DNS from First Principles/Code/docs/book/rgbdns.md.source|docs/book/rgbdns.md]]
- Lines: 1199-1244
- Subsystem: [[DNS from First Principles/Subsystems/Documentation|Documentation]]

```rgbdns-fragment
{"id": "rgbdns-frag-d6879609a68f", "codeNote": "DNS from First Principles/Code/docs/book/rgbdns.md.source", "heading": "rgbdns-frag-d6879609a68f: heading Rust as a protocol-design tool", "sourcePath": "docs/book/rgbdns.md", "startLine": 1199, "endLine": 1244}
```

## Excerpt

<span id="rgbdns-frag-d6879609a68f" class="rgbdns-fragment-target"></span>
### rgbdns-frag-d6879609a68f: heading Rust as a protocol-design tool
