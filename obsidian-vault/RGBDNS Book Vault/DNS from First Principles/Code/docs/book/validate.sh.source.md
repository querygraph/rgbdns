...
- Source path: `docs/book/validate.sh`
- Lines: 47
- Summary: A direct Typst PDF carries Creator: Typst. The FirstPair image-cover path

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-e28ee5b6ddec|validate.sh]]: lines 1-47
