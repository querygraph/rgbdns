...
- [[DNS from First Principles/Fragments/rgbdns-frag-ca8e2e56fa9a|Preface {-}]]: lines 1-21
- [[DNS from First Principles/Fragments/rgbdns-frag-725ebb52a2aa|The problem DNS solves]]: lines 22-23
- [[DNS from First Principles/Fragments/rgbdns-frag-4c85445184dc|Identity is not location]]: lines 24-53
- [[DNS from First Principles/Fragments/rgbdns-frag-861b81bcf5ae|Requirements that pull in different directions]]: lines 54-72
- [[DNS from First Principles/Fragments/rgbdns-frag-8dbfb904e1a6|Roles, not just “DNS servers”]]: lines 73-95
- [[DNS from First Principles/Fragments/rgbdns-frag-0446b5c1d2ef|Names form a delegated tree]]: lines 96-97
- [[DNS from First Principles/Fragments/rgbdns-frag-836056690903|Labels and the root]]: lines 98-127
- [[DNS from First Principles/Fragments/rgbdns-frag-8679aacc97e7|Zones are administrative cuts]]: lines 128-149
