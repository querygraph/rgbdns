...
- Source path: `docs/blog/announcing-rgbdns/post.md`
- Lines: 176
- Summary: Announcing rgbdns: DNS from first principles, rebuilt in Rust

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-9286d7698383|Announcing rgbdns DNS from first principles, rebuilt in Rust]]: lines 1-20
- [[DNS from First Principles/Fragments/rgbdns-frag-54eee914935f|A suite of small programs]]: lines 21-42
- [[DNS from First Principles/Fragments/rgbdns-frag-f73fe576d5fc|Compatibility without inherited memory hazards]]: lines 43-60
- [[DNS from First Principles/Fragments/rgbdns-frag-7c406a9cb2de|Conformance is a test matrix]]: lines 61-90
- [[DNS from First Principles/Fragments/rgbdns-frag-c27792d1c22e|Hardening that came from the tests]]: lines 91-110
- [[DNS from First Principles/Fragments/rgbdns-frag-e17a55da878c|Measure before calling it faster]]: lines 111-136
- [[DNS from First Principles/Fragments/rgbdns-frag-6ce528da9068|Running without `supervise`]]: lines 137-154
- [[DNS from First Principles/Fragments/rgbdns-frag-16ff20b96f17|Read the book, inspect the source]]: lines 155-176
