...
- Source path: `docs/performance.md`
- Lines: 55
- Summary: Performance methodology

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-9d0d58ec4f3e|Performance methodology]]: lines 1-33
- [[DNS from First Principles/Fragments/rgbdns-frag-6c356aa252b7|Optimization checkpoint]]: lines 34-55
