...
# tests/drill_interop.rs

- Subsystem: [[DNS from First Principles/Subsystems/Tests and performance|Tests and performance]]
- Source path: `tests/drill_interop.rs`
- Lines: 106
- Summary: Source file in the Tests and performance subsystem.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-130b7d43bd73|Server]]: lines 10-14
- [[DNS from First Principles/Fragments/rgbdns-frag-70fa07c23ea9|Drop]]: lines 15-15
- [[DNS from First Principles/Fragments/rgbdns-frag-0efac99de072|drop]]: lines 16-22
- [[DNS from First Principles/Fragments/rgbdns-frag-c79ac41f0fa0|drill_available]]: lines 23-31
- [[DNS from First Principles/Fragments/rgbdns-frag-e75608ea3a7a|start_server]]: lines 32-62
- [[DNS from First Principles/Fragments/rgbdns-frag-7d1dc561d03d|drill]]: lines 63-84
- [[DNS from First Principles/Fragments/rgbdns-frag-887f4bda18f1|ldns_drill_interoperates_over_udp_tcp_edns_and_unknown_types]]: lines 85-106
