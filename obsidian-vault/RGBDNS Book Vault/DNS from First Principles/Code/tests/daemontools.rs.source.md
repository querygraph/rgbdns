...
# tests/daemontools.rs

- Subsystem: [[DNS from First Principles/Subsystems/Tests and performance|Tests and performance]]
- Source path: `tests/daemontools.rs`
- Lines: 99
- Summary: Source file in the Tests and performance subsystem.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-8087eb39852c|directory]]: lines 12-23
- [[DNS from First Principles/Fragments/rgbdns-frag-141adf020e41|multilog_binary_timestamps_and_rotates]]: lines 24-56
- [[DNS from First Principles/Fragments/rgbdns-frag-1bd53b40fae4|setuidgid_replaces_itself_and_preserves_child_status]]: lines 57-67
- [[DNS from First Principles/Fragments/rgbdns-frag-62336da4de19|tai64_filters_roundtrip_a_published_timestamp]]: lines 68-99
