...
- Source path: `tests/dnscache_network.rs`
- Lines: 72
- Summary: This is excluded from default offline builds because it deliberately

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-707ff164d3a9|CacheProcess]]: lines 8-8
- [[DNS from First Principles/Fragments/rgbdns-frag-1e9ebdb40294|Drop]]: lines 9-9
- [[DNS from First Principles/Fragments/rgbdns-frag-739b25308507|drop]]: lines 10-15
- [[DNS from First Principles/Fragments/rgbdns-frag-41b924ae97ce|query]]: lines 16-47
- [[DNS from First Principles/Fragments/rgbdns-frag-0f8ff5c7a060|validates_secure_and_rejects_bogus_dnssec]]: lines 48-72
