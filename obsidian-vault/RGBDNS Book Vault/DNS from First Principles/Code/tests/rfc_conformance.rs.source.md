...
- Source path: `tests/rfc_conformance.rs`
- Lines: 313
- Summary: Source file in the Tests and performance subsystem.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-69e831b1a28c|support]]: lines 1-6
- [[DNS from First Principles/Fragments/rgbdns-frag-5292cc2a0403|rfc1035_response_identity_flags_and_question_are_coherent]]: lines 7-22
- [[DNS from First Principles/Fragments/rgbdns-frag-114e43800a7f|rfc9619_standard_queries_require_exactly_one_question]]: lines 23-37
- [[DNS from First Principles/Fragments/rgbdns-frag-e4b1690ff7a3|rfc8906_unknown_opcode_is_notimp_even_when_its_body_is_unknown]]: lines 38-51
- [[DNS from First Principles/Fragments/rgbdns-frag-6a8de18b800c|rfc8906_all_unimplemented_opcodes_get_notimp_without_flag_reflection]]: lines 52-65
- [[DNS from First Principles/Fragments/rgbdns-frag-e4a8c49fe363|rfc8906_unknown_header_flags_do_not_suppress_or_taint_answers]]: lines 66-78
- [[DNS from First Principles/Fragments/rgbdns-frag-b2c41a84e938|rfc8906_unknown_types_use_name_existence_not_notimp]]: lines 79-91
- [[DNS from First Principles/Fragments/rgbdns-frag-7da8254d757f|rfc1035_unsupported_query_class_gets_notimp]]: lines 92-99
- [[DNS from First Principles/Fragments/rgbdns-frag-bb7e008e7e8c|rfc2308_nodata_and_nxdomain_are_distinct_and_include_soa]]: lines 100-112
- [[DNS from First Principles/Fragments/rgbdns-frag-da555be27060|rfc2308_negative_soa_ttl_is_the_minimum_of_soa_ttl_and_minimum]]: lines 113-124
- [[DNS from First Principles/Fragments/rgbdns-frag-1d4ea2f18c5d|rfc6891_edns_is_acknowledged_and_do_is_copied]]: lines 125-145
- [[DNS from First Principles/Fragments/rgbdns-frag-d45c57d47515|rfc6891_unknown_well_formed_options_are_ignored]]: lines 146-160
- [[DNS from First Principles/Fragments/rgbdns-frag-0663f957b0bd|rfc6891_badvers_uses_the_extended_response_code]]: lines 161-169
- [[DNS from First Principles/Fragments/rgbdns-frag-63702d1be377|rfc8906_badvers_survives_unknown_edns_flags_and_options]]: lines 170-187
- [[DNS from First Principles/Fragments/rgbdns-frag-04e910bc5479|rfc6891_duplicate_or_misplaced_opt_is_formerr]]: lines 188-203
- [[DNS from First Principles/Fragments/rgbdns-frag-bd13b0414c83|rfc6891_advertised_udp_limit_is_honored_with_parseable_truncation]]: lines 204-222
- [[DNS from First Principles/Fragments/rgbdns-frag-98d21a984576|rfc3597_unknown_rdata_roundtrips_losslessly]]: lines 223-239
- [[DNS from First Principles/Fragments/rgbdns-frag-c211f7926605|rfc4343_name_comparison_is_ascii_case_insensitive]]: lines 240-249
- [[DNS from First Principles/Fragments/rgbdns-frag-ca2394e2c026|rfc4592_closest_encloser_blocks_a_higher_wildcard]]: lines 250-265
- [[DNS from First Principles/Fragments/rgbdns-frag-3abbe7dfdfde|rfc2181_referral_contains_only_in_bailiwick_glue]]: lines 266-279
- [[DNS from First Principles/Fragments/rgbdns-frag-89725a937c01|rfc2181_rrset_ttls_are_equalized_and_duplicate_records_suppressed]]: lines 280-295
- [[DNS from First Principles/Fragments/rgbdns-frag-3b974cea6322|rfc2181_cname_cannot_coexist_with_other_data_or_multiple_targets]]: lines 296-313
