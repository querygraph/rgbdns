...
# tests/wire_security.rs

- Subsystem: [[DNS from First Principles/Subsystems/Tests and performance|Tests and performance]]
- Source path: `tests/wire_security.rs`
- Lines: 108
- Summary: Source file in the Tests and performance subsystem.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-d3e351ff4ce5|standard_header]]: lines 3-11
- [[DNS from First Principles/Fragments/rgbdns-frag-60240fa31419|rfc1035_maximum_name_is_accepted_and_one_octet_more_is_rejected]]: lines 12-33
- [[DNS from First Principles/Fragments/rgbdns-frag-b05f56fdf049|malformed_wire_corpus_is_rejected_without_partial_acceptance]]: lines 34-70
- [[DNS from First Principles/Fragments/rgbdns-frag-8e52eff80870|compression_pointer_must_target_a_previous_name_boundary]]: lines 71-87
- [[DNS from First Principles/Fragments/rgbdns-frag-999162e0163d|decoder_rejects_every_truncation_of_a_valid_structured_packet]]: lines 88-108
