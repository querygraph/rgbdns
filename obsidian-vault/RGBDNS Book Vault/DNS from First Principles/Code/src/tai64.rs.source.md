...
- Source path: `src/tai64.rs`
- Lines: 239
- Summary: TAI64N timestamp generation, parsing, and stream filters.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-80eb2b927d46|TAI64_BIAS]]: lines 9-9
- [[DNS from First Principles/Fragments/rgbdns-frag-b50c3479e284|INITIAL_TAI_UTC_OFFSET]]: lines 10-12
- [[DNS from First Principles/Fragments/rgbdns-frag-241a6862cf68|LEAP_TRANSITIONS]]: lines 13-43
- [[DNS from First Principles/Fragments/rgbdns-frag-abd7554f2908|Timestamp]]: lines 44-48
- [[DNS from First Principles/Fragments/rgbdns-frag-a3453c75cf0d|label]]: lines 49-59
- [[DNS from First Principles/Fragments/rgbdns-frag-d0a245dbd3a0|parse_label]]: lines 60-76
- [[DNS from First Principles/Fragments/rgbdns-frag-c734e132fddb|local]]: lines 77-90
- [[DNS from First Principles/Fragments/rgbdns-frag-47a1aedc6982|stamp]]: lines 91-113
- [[DNS from First Principles/Fragments/rgbdns-frag-cd84a6e4e5b5|localize]]: lines 114-152
- [[DNS from First Principles/Fragments/rgbdns-frag-44a8add7a5dd|copy_line_remainder]]: lines 153-171
- [[DNS from First Principles/Fragments/rgbdns-frag-a11b4738a02f|offset_at_utc]]: lines 172-176
- [[DNS from First Principles/Fragments/rgbdns-frag-cd7bdf864d6f|tai_to_unix]]: lines 177-189
- [[DNS from First Principles/Fragments/rgbdns-frag-9edc2446097b|tests]]: lines 190-194
- [[DNS from First Principles/Fragments/rgbdns-frag-b6462bf1696c|matches_the_published_daemontools_example]]: lines 195-201
- [[DNS from First Principles/Fragments/rgbdns-frag-4ecc3d4e7baf|current_labels_include_the_post_2017_offset]]: lines 202-214
- [[DNS from First Principles/Fragments/rgbdns-frag-2c2cadfbad0f|stream_filters_preserve_lines_and_invalid_prefixes]]: lines 215-233
- [[DNS from First Principles/Fragments/rgbdns-frag-3a8ceac83fcb|rejects_malformed_and_out_of_range_labels]]: lines 234-239
