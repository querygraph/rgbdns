...
# src/dnscache_config.rs

- Subsystem: [[DNS from First Principles/Subsystems/Resolution and recursion|Resolution and recursion]]
- Component: [[DNS from First Principles/Components/rgbdns|rgbdns]]
- Source path: `src/dnscache_config.rs`
- Lines: 266
- Summary: Compatibility handling for djbdns `dnscache` root-server files.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-3790fed38817|MAX_ROOTS_FILE]]: lines 12-12
- [[DNS from First Principles/Fragments/rgbdns-frag-f59cd49b7a3e|MAX_ROOT_ADDRESSES]]: lines 13-13
- [[DNS from First Principles/Fragments/rgbdns-frag-e2e70010249a|MAX_FORWARD_ZONES]]: lines 14-16
- [[DNS from First Principles/Fragments/rgbdns-frag-128d48d8a73e|ForwardZone]]: lines 17-26
- [[DNS from First Principles/Fragments/rgbdns-frag-c527bbc0d8ea|PreparedRoots]]: lines 27-31
- [[DNS from First Principles/Fragments/rgbdns-frag-2ed2d81c2acf|PreparedRoots]]: lines 32-32
- [[DNS from First Principles/Fragments/rgbdns-frag-1c885999a2f2|from_environment]]: lines 33-45
- [[DNS from First Principles/Fragments/rgbdns-frag-578de589f37c|prepare]]: lines 46-98
- [[DNS from First Principles/Fragments/rgbdns-frag-2f06d4f4885b|path]]: lines 99-104
- [[DNS from First Principles/Fragments/rgbdns-frag-b786d792c7bd|forward_zones_from_environment]]: lines 105-111
- [[DNS from First Principles/Fragments/rgbdns-frag-1e7130f48d35|load_forward_zones]]: lines 112-158
- [[DNS from First Principles/Fragments/rgbdns-frag-90910fbcda6b|Drop]]: lines 159-159
- [[DNS from First Principles/Fragments/rgbdns-frag-975a8cad85d6|drop]]: lines 160-166
- [[DNS from First Principles/Fragments/rgbdns-frag-1997fc89b5d1|private_temporary_path]]: lines 167-186
- [[DNS from First Principles/Fragments/rgbdns-frag-a545b39517cc|write_private]]: lines 187-201
- [[DNS from First Principles/Fragments/rgbdns-frag-1ff993436298|tests]]: lines 202-204
- [[DNS from First Principles/Fragments/rgbdns-frag-3c0309848984|path]]: lines 205-209
- [[DNS from First Principles/Fragments/rgbdns-frag-896528afc440|converts_legacy_ipv4_and_ipv6_server_lines]]: lines 210-224
- [[DNS from First Principles/Fragments/rgbdns-frag-4372b73cba03|preserves_master_files_and_rejects_mixed_input]]: lines 225-244
- [[DNS from First Principles/Fragments/rgbdns-frag-78979cd5a287|loads_bounded_per_zone_forwarders]]: lines 245-266
