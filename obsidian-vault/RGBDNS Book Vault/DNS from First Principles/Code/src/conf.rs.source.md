...
- Source path: `src/conf.rs`
- Lines: 299
- Summary: Portable service-directory generators for the djbdns daemons.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-dda2855f47d7|Service]]: lines 11-19
- [[DNS from First Principles/Fragments/rgbdns-frag-e9018c070678|configure]]: lines 20-100
- [[DNS from First Principles/Fragments/rgbdns-frag-47c3cd5b1372|configure_tinydns]]: lines 143-176
- [[DNS from First Principles/Fragments/rgbdns-frag-950f5158793d|configure_dnscache]]: lines 177-191
- [[DNS from First Principles/Fragments/rgbdns-frag-f23762f8b911|make_log]]: lines 192-207
- [[DNS from First Principles/Fragments/rgbdns-frag-40627baa9dd5|run_script]]: lines 208-222
- [[DNS from First Principles/Fragments/rgbdns-frag-ca6aa7f85b39|executable]]: lines 223-230
- [[DNS from First Principles/Fragments/rgbdns-frag-71ec2b6bd4ef|shell_quote]]: lines 231-234
- [[DNS from First Principles/Fragments/rgbdns-frag-b0dca80a842d|write_file]]: lines 235-247
- [[DNS from First Principles/Fragments/rgbdns-frag-b347d98cd7ff|tests]]: lines 248-251
- [[DNS from First Principles/Fragments/rgbdns-frag-33e30225780d|directory]]: lines 252-263
- [[DNS from First Principles/Fragments/rgbdns-frag-ba9506807310|creates_tinydns_service_tree_without_overwriting]]: lines 264-285
- [[DNS from First Principles/Fragments/rgbdns-frag-32f847460f21|dnscache_tree_contains_current_hints_and_private_seed]]: lines 286-299
