...
- Source path: `src/client.rs`
- Lines: 246
- Summary: Small bounded stub-resolver shared by the djbdns-compatible client tools.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-d8a776f4a8ff|TIMEOUT]]: lines 11-12
- [[DNS from First Principles/Fragments/rgbdns-frag-87ff6d272c3e|recursive]]: lines 13-16
- [[DNS from First Principles/Fragments/rgbdns-frag-8adf36f03d5d|query]]: lines 17-56
- [[DNS from First Principles/Fragments/rgbdns-frag-690e4ae608a4|servers]]: lines 57-83
- [[DNS from First Principles/Fragments/rgbdns-frag-c4ff7d3f54c7|server_address]]: lines 84-93
- [[DNS from First Principles/Fragments/rgbdns-frag-5406a3b7ab21|udp_query]]: lines 94-109
- [[DNS from First Principles/Fragments/rgbdns-frag-4c8bd136a924|tcp_query]]: lines 110-126
- [[DNS from First Principles/Fragments/rgbdns-frag-460f16558db2|validate]]: lines 127-139
- [[DNS from First Principles/Fragments/rgbdns-frag-3d3fb10dac1b|random_id]]: lines 140-147
- [[DNS from First Principles/Fragments/rgbdns-frag-99e21bd0c5e3|tests]]: lines 148-153
- [[DNS from First Principles/Fragments/rgbdns-frag-681cb74d8929|truncated_udp_response_falls_back_to_tcp]]: lines 154-207
- [[DNS from First Principles/Fragments/rgbdns-frag-b8619bcfbdf7|parses_bare_and_explicit_port_server_addresses]]: lines 208-219
- [[DNS from First Principles/Fragments/rgbdns-frag-18a7a053e51c|rejects_responses_with_a_mismatched_question_opcode_or_tcp_truncation]]: lines 220-246
