...
- Source path: `src/rbl.rs`
- Lines: 286
- Summary: djbdns-compatible IPv4 DNS block-list data and responses.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-9f7542b27b04|Database]]: lines 7-11
- [[DNS from First Principles/Fragments/rgbdns-frag-62c57b5d4098|Database]]: lines 12-12
- [[DNS from First Principles/Fragments/rgbdns-frag-0b879085623a|parse]]: lines 13-48
- [[DNS from First Principles/Fragments/rgbdns-frag-5afd89c2f911|from_file]]: lines 49-57
- [[DNS from First Principles/Fragments/rgbdns-frag-9050d2bc5501|from_cdb]]: lines 58-81
- [[DNS from First Principles/Fragments/rgbdns-frag-5b0773f6dd79|listed]]: lines 82-93
- [[DNS from First Principles/Fragments/rgbdns-frag-554c269fd7f5|response]]: lines 94-100
- [[DNS from First Principles/Fragments/rgbdns-frag-1db326c82984|respond]]: lines 101-151
- [[DNS from First Principles/Fragments/rgbdns-frag-d570caaa761a|compile]]: lines 152-176
- [[DNS from First Principles/Fragments/rgbdns-frag-1d938f8ec076|parse_network]]: lines 177-195
- [[DNS from First Principles/Fragments/rgbdns-frag-5ef61ed6f137|numeric_prefix]]: lines 196-220
- [[DNS from First Principles/Fragments/rgbdns-frag-04727e3cc77c|tests]]: lines 221-225
- [[DNS from First Principles/Fragments/rgbdns-frag-fbc8bb9e3567|query]]: lines 226-240
- [[DNS from First Principles/Fragments/rgbdns-frag-a8de23dd524c|most_specific_network_and_substitution]]: lines 241-268
- [[DNS from First Principles/Fragments/rgbdns-frag-5447f3067350|cdb_roundtrip_preserves_rbl_answers]]: lines 269-286
