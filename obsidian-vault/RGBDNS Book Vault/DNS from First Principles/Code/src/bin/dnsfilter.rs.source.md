...
# src/bin/dnsfilter.rs

- Subsystem: [[DNS from First Principles/Subsystems/Command-line programs|Command-line programs]]
- Component: [[DNS from First Principles/Components/dnsfilter|dnsfilter]]
- Source path: `src/bin/dnsfilter.rs`
- Lines: 119
- Summary: Source file in the Command-line programs subsystem.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-d5f7800921ae|main]]: lines 13-19
- [[DNS from First Principles/Fragments/rgbdns-frag-1d5ad9c1babc|run]]: lines 20-35
- [[DNS from First Principles/Fragments/rgbdns-frag-8d3f2bd5f0c8|options]]: lines 36-52
- [[DNS from First Principles/Fragments/rgbdns-frag-a2e32cc499c2|process]]: lines 53-85
- [[DNS from First Principles/Fragments/rgbdns-frag-75f2307fa91a|filter_line]]: lines 86-119
