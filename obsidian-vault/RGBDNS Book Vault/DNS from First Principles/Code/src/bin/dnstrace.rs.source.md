...
- Source path: `src/bin/dnstrace.rs`
- Lines: 94
- Summary: Source file in the Command-line programs subsystem.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-ed917dea9ded|main]]: lines 4-10
- [[DNS from First Principles/Fragments/rgbdns-frag-54265fcbc19e|run]]: lines 11-91
