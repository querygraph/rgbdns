...
# src/bin/random-ip.rs

- Subsystem: [[DNS from First Principles/Subsystems/Command-line programs|Command-line programs]]
- Component: [[DNS from First Principles/Components/random-ip|random-ip]]
- Source path: `src/bin/random-ip.rs`
- Lines: 72
- Summary: Source file in the Command-line programs subsystem.

## Extracted Fragments

- [[DNS from First Principles/Fragments/rgbdns-frag-0685245d19c6|main]]: lines 1-7
- [[DNS from First Principles/Fragments/rgbdns-frag-cb4b85086182|run]]: lines 8-61
- [[DNS from First Principles/Fragments/rgbdns-frag-04dab64f1b7a|uniform]]: lines 62-72
