...
rpm -qip dist/rpmbuild/RPMS/x86_64/rgbdns-0.1.1-1.x86_64.rpm
rpm -qlp dist/rpmbuild/RPMS/x86_64/rgbdns-0.1.1-1.x86_64.rpm
```
...
```sh
rpm -K dist/cloud-rpm/rgbdns-0.1.1-1.x86_64.rpm
rpm -qip dist/cloud-rpm/rgbdns-0.1.1-1.x86_64.rpm
rpm -qlp dist/cloud-rpm/rgbdns-0.1.1-1.x86_64.rpm
```
