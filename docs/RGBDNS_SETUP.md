...
This walkthrough deploys rgbdns 0.6.4 on two AWS EC2 instances and retains
...
The 0.6.4 artifacts are:

```text
rgbdns_0.6.4_amd64.deb
RPMS/x86_64/rgbdns-0.6.4-1.x86_64.rpm
SRPMS/rgbdns-0.6.4-1.src.rpm
```
...
```sh
scp "$HOME/rgbdns-deb/rgbdns_0.6.4_amd64.deb" \
...
```sh
sudo apt install /tmp/rgbdns_0.6.4_amd64.deb
...
```sh
scp "$HOME/rgbdns-rpm/RPMS/x86_64/rgbdns-0.6.4-1.x86_64.rpm" \
