...
This walkthrough deploys rgbdns 0.5.2 on two AWS EC2 instances and retains
...
The 0.5.2 artifacts are:

```text
rgbdns_0.5.2_amd64.deb
RPMS/x86_64/rgbdns-0.5.2-1.x86_64.rpm
SRPMS/rgbdns-0.5.2-1.src.rpm
```
...
```sh
scp "$HOME/rgbdns-deb/rgbdns_0.5.2_amd64.deb" \
...
```sh
sudo apt install /tmp/rgbdns_0.5.2_amd64.deb
...
```sh
scp "$HOME/rgbdns-rpm/RPMS/x86_64/rgbdns-0.5.2-1.x86_64.rpm" \
